...
- **Original languages**: Strong's Hebrew and Greek lexicon, Thayer's Greek lexicon, and a word-by-word interlinear with parsing. Double-click any word in the text for its entry.
