...
- **Fifteen English Bible translations**: King James (1769), American Standard (1901), Young's Literal, Darby, Webster's, Geneva (1599), Douay-Rheims, Tyndale, Wycliffe, the World English Bible, and five modern ones free to share: the Berean Standard Bible, the Literal Standard Version, the Open English Bible, and unfoldingWord's Literal and Simplified Texts. Translations you own can be added from Zefania XML.
