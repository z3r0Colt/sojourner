...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::scripture_memory::set_memory_verse_ask_reference,
            commands::scripture_memory::create_memory_passage,
            commands::scripture_memory::list_memory_passages,
            commands::scripture_memory::add_next_memory_passage_part,
            commands::scripture_memory::delete_memory_passage,
            commands::scripture_memory::list_memory_review_times,
            ...
            commands::reference::get_factbook_for_word,
            commands::reference::search_factbook,
            commands::reference::list_lexicon_sources,
            commands::reference::get_lexicon_entries,
            commands::reference::get_lexicon_entry,
            commands::reference::lexicons_for_strongs,
            commands::reference::search_lexicons,
            ...
            commands::sermons::list_sermon_ideas,
            commands::sermons::create_sermon_idea,
            commands::sermons::update_sermon_idea,
            commands::sermons::file_sermon_idea,
            commands::sermons::delete_sermon_idea,
            ...
            commands::sermons::export_sermon_podium,
