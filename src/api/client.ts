...
export const api = {
  ...
  getFactbookForWord: (bookId: number, chapter: number, verse: number, word: string, strongsId: string | null) =>
    invoke<FactbookSummary | null>("get_factbook_for_word", { bookId, chapter, verse, word, strongsId }),
  searchFactbook: (query: string, limit = 30) => invoke<FactbookSummary[]>("search_factbook", { query, limit }),
