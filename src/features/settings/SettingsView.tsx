...
export function SettingsView() {
  // Deep-linkable via ?section=tutorial (e.g. the first-run tutorial banner).
  const [searchParams] = useSearchParams();
  const fromUrl = searchParams.get("section");
  const [section, setSection] = useState<Section>(isSection(fromUrl) ? fromUrl : "preferences");

  return (
    <div className="mx-auto flex h-full w-full max-w-4xl gap-8 px-6 py-6">
