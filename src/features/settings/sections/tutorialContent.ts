    ...
    entries: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Type your words. Plain words are all required; put a phrase in \"quotes\" for an exact phrase; write word1 OR word2 for either; write -word to leave a word out.",
          "Switch tabs across the top to see each kind of result with its count.",
          "On the Scripture tab, choose which translation to search: the one you are reading, all of them, or any one. The Commentary tab chooses a commentary the same way.",
          "Narrow Scripture and commentary to a testament or one book, and list them by best match or in Bible order. Tick Whole words to stop son from finding song.",
          "Scripture and Commentary say how many matched in all; Show more brings the rest, up to five hundred.",
          "Use [↓] and [↑] to move through results and [Enter] to open one.",
          "Click Save beside the box to keep a query one click away.",
        ],
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        what: "Ten public-domain translations ship with the app; a copyrighted one can be added from your own file.",
        steps: [
          "Pick a translation from the dropdown in the reading toolbar. Each Bible pane keeps its own choice.",
