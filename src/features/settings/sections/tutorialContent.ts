...
export const TUTORIAL: TutorialCategory[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        what: "Today is one page over everything: eight blocks in a fixed order, and any block with nothing to show stays hidden. A new install opens on it.",
        steps: [
          "Click Today, the first item in the sidebar. The app opens here the first time; after that it opens as you left it.",
          ...
          "Family worship shows what the family reads, sings, learns, memorizes and prays for next, with Begin and Gather round. Until it is set up it is a one-time invitation; Not now puts it away.",
    ...
    entries: [
      {
        ...
        steps: [
          "Open Memory in the sidebar and type a reference under Add a verse, a passage, or a whole psalm, such as Philippians 4:6-7 or Psalm 23.",
          "Choose the Translation: the box starts on the one you are reading, and Reader's translation follows whichever Bible you have open (the KJV until you have opened one).",
          ...
          "Tick Also practise where it is, or click Where on a card's row, and every other time the card shows you the words and asks for the reference instead.",
        ],
        links: [{ label: "Memory", to: "/memory" }],
      },
      {
        id: "memory-passages",
        title: "Learn a passage a part at a time",
        what: "Four verses or more, or a whole chapter, are learned a few verses at a time, then said all through.",
        steps: [
          "Add a passage such as Psalm 23 or Romans 8:28-39. Learn it decides by length; choose All at once, or one to four verses at a time, to decide yourself.",
          "The first part comes into the deck at once. When you have recalled it twice running, the next part is added, and once every part is learned, the whole passage, to say through.",
          "Passages, a part at a time lists each one with a bar showing its parts. Add the next part now is for when you already know the part you are on; Practise runs all of its parts.",
        ],
        links: [{ label: "Memory", to: "/memory" }],
      },
      {
        id: "memory-sets",
        title: "Ready-made sets, and your own",
        what: "Add a whole set at once: the Romans Road, For little ones, Psalms by heart, the Ten Commandments, the Lord's Prayer, the Beatitudes, the Great Commission, Assurance.",
        steps: [
          "Open Ready-made sets on the Memory page and click Add beside a set. Its long passages are learned a part at a time.",
          "Each card keeps its set's name. The chips above the deck show one set at a time, and Practice what's due then practises only that set.",
          "A verse added while a set is showing goes into that set.",
        ],
        links: [{ label: "Memory", to: "/memory" }],
      },
      {
      ...
      },
      {
        id: "memory-catechism",
        title: "Catechism",
        what: "The Catechism tab memorizes answers from the Shorter, Larger or Heidelberg Catechism, or the Catechism for Young Children, with the same tools.",
        steps: [
          "Click the Catechism tab on the Memory page.",
          "Add a question by number; practice and grade it the same way. Read in context opens the question in the Confessions.",
          "Learn the proof texts too puts each question's first Scripture proof into your Scripture deck, linked to its question, so the verse and the answer it proves are learned together.",
        ],
        links: [{ label: "Memory", to: "/memory" }],
      },
    ],
    ...
    entries: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Click Memory verses for a verse a week to go with the series: each starts as the sermon's text (or its first verse), and you can change any. Add them to my Memory deck puts them in a set named for the series; Print cards for the congregation prints a sheet of cards, one per Sunday, to cut apart and hand out.",
        ],
        links: [{ label: "Sermons", to: "/sermons" }],
      },
      {
