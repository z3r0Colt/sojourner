...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Open the study panel", a: 'Click "Study" (or the ‹ tab on the right edge) to open the right-hand panel with Commentary and Cross References tabs.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Search your sermon notes", a: "The search box at the top of the Sermons page searches title, preacher, passage, outline, and application text together." },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Practice modes", a: '"First letter" shows only the first letter of each word as a hint; "Blank word" hides random whole words. Change a verse\'s mode any time from its row.' },
