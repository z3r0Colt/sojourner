...
import { CommentaryPane, ConfessionPane, CrossRefsPane, EncyclopediaForPassagePane, FactbookForPassagePane, InterlinearPane, MetricalPane, MinePane } from "./panes/StudyPanes";
